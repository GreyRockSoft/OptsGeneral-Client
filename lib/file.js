...
module.exports.mkdir = function(name, options, callback) {
  if(typeof(options) === 'function') {
    mkdir(name, options); //options is a callback function here
  }
  else{
...
module.exports.download = function download(file, outputName, options, callback) {
  fs.exists(outputName, function(exists){
    if(exists) {  //TODO add checksum check later
      if(typeof(options) === 'function') { // TODO pull this out into it's own function
        options();
      }
      else {
        callback();
